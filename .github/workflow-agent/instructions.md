...
For screenshots and videos, read `.github/workflow-agent/captures.md`: capture with a temporary system spec, upload with `upload_image`, and include the URL in your response.
